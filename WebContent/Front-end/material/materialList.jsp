...
<body onload="startit();">
	...
	<div id="center">
		...
		<div id="main">
			<form name="form1" method="post" action="materialSearchList.html"
				...
				</select> <input type="text" name="onetext" value="请输入关键字" id="txt1"
					onfocus="selectText();" /> <input type="submit" name="Submit"
					value="查询" />
			</form>
			<form name="form2" method="post" action="#"
				onsubmit="return befSubmit();">
				<div id="table">
					<table id="ec_table">
						...
						<thead>
							...
							<tr>
								...
								<td >${Material.materialCount }</td>
								<td >${Material.materialPrice }</td>
								<td >${Material.materialInDate }</td>
								<td >${Material.materialOutDate }</td>
								<td >${Material.typeId }</td>
								<td >${Material.materialStat }</td>
								<td>修改</td>
							</tr>
							</c:forEach>
						</thead>
						<tbody>
							<tr onmousemove="this.className='lightup';"
								...
								<td><a href="materialUpdate.html">edit</a></td>
							</tr>
							...
							<tr>
								<td colspan="9">
									...
									<ul>
										...
										<li>后页</li>
										<li>末页</li>
										<li><span>转到</span> <select name="" id="pagenumber"
											onchange="build();">
								...
								<td colspan="9">
									<ul>
										<li><input name="addnews" type="button" value="添 加"
											...
											onclick="window.location='materialAdd.html'" /></li>
										<li><input name="sumselect" type="button" value="全 选"
											class="button" onmouseout="this.className='button';"
											onmouseover="this.className='buttondown';"
											onclick="checkAll();" /></li>
										<li><input name="delete" type="submit" value="删 除"
											class="button" onmouseout="this.className='button';"
